    ...
    public partial class manageitem : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                table.Append("<td width=50>" + "<a href = 'adminEditProduct.aspx?id=" + dr[0] + "'><button type='button' class='btn btn - primary'>Edit</button></a>" + "</td>");
                table.Append("<td width=50>" + "<a href = 'manageDeleteIte.aspx?id=" + dr[0] + "'><button type='button' class='btn btn - primary'>Delete</button></a>" + "</td>");
                table.Append("</tr>");
                i++;
            }
            table.Append("</table>");
